...
export interface Tenant {
  id: string;
  /**
   * This is the name of the store(e.g Sidra's Store)
   */
  name: string;
  /**
   * This is the name of the store(e.g [slug].canvastocase.com)
   */
  slug: string;
...
export interface Product {
  ...
  image?: (string | null) | Media;
  refundPolicy?: ('30-day' | '14-days' | '7-days' | '3-days' | '1-day' | 'no-refunds') | null;
  updatedAt: string;
  createdAt: string;
}
/**
